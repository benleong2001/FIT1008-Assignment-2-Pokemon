...
class ArrayStack(Stack[T]):
    ...
    def __str__(self) -> str:
        """ Magic method constructing a string representation of the ArrayStack.
        :return:        Returns the ArrayStack object's string representation.
        ...
        """
        return ", ".join(
            [str(x) if isinstance(x, PokemonBase) and x.is_alive() else str(x) for x in self.array[len(self) - 1:: -1]])
